...
for (let i = 0; i < 50; i++) {
    ...
    const radius = 3 + Math.random() * 6 // Random distance from the center
...
roof.position.y = 2.5 + 0.5 // Height of walls + half height of roof
...
door.position.y = 1.1 // Half height of door
door.position.z = 2 + 0.01 // Slightly in front of walls to avoid z-fighting
house.add(door)
...
doorLight.position.set(0, 2.2, 2 + 0.01) // Slightly in front of door
